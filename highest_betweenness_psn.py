...
os.chdir(r"C:\Users\saySa\OneDrive\Desktop\test_pp_complex")
...
#--- BETWEENNES CENTRALITY OF NODES
BCe1 = nx.betweenness_centrality(H1)
tem1 = pd.DataFrame(BCe1.items(), columns=['CA_Atoms', 'betweenness'])
tem2 = tem1.sort_values(['betweenness'], ascending=[False])
BCe2 = nx.betweenness_centrality(H2)
tem3 = pd.DataFrame(BCe2.items(), columns=['CA_Atoms', 'betweenness'])
tem4 = tem3.sort_values(['betweenness'], ascending=[False])

#--- EDGE BETWEENNESS CENTRALITY
edge_BCe1 = nx.edge_betweenness_centrality(H1)
edge_BCe2 = nx.edge_betweenness_centrality(H2)